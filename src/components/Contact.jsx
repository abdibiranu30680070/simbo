    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-50 to-teal-50">
      <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-28 2xl:mx-34 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-teal-600 font-semibold text-lg">Contact Us</span>
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 text-xl mb-2">{info.title}</h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-teal-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2"
              >
                {loading ? (
                  <>
